...
namespace DeRosaWebApp.Context
{
    public class AppDbContext : IdentityDbContext<IdentityUser>
    {
        ...
        {
            optionsBuilder.UseSqlServer(connectionString: @"Data Source=Alex;Database=DeRosaDb;Integrated Security=True; TrustServerCertificate=True;MultipleActiveResultSets=True;");
